...
<html lang="en">
    <head>
        ...
        <title>Hệ thống đặt vé máy báy trực tuyến</title>         
...
.btn-login {
    ...
    <body>        
        ...
        <a class="navbar-brand pt-0" href="index.php"><img src="assets/images/Jetstarlogo.svg" style="width:90%">            
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a id = "trangchu" class="nav-link" href="index.php">
                        <h5> Trang chủ</h5>
                    </a>
                </li>                                             
            ...
            <?php } ?>
                <li class="nav-item">
                    <a class="nav-link" href="https://vnexpress.net/tag/may-bay-254167">
                        <h5> Tin tức</h5>
                    </a>
                </li> 
                <li class="nav-item">

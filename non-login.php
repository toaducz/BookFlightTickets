    ...
    <div class="col-md-12 main-col">
        ...
        <?php for($i=1;$i<=$passengers;$i++) {
            ...
            <div class="form-row">
                <div class="col-md">
                    <div class="input-group">
                        <label for="firstname'.$i.'">Tên</label>
                ...
                <div class="col-md">
                    <div class="input-group">
                        <label for="midname'.$i.'">Chữ lót</label>
            ...
            <div class="form-row">
                <div class="col-md">
                    <div class="input-group">
                        <label for="mobile'.$i.'">SỐ điện thoại</label>

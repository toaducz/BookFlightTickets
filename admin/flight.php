      ...
      <form method="POST" class=" text-center" 
        ...
        <div class="form-row mb-4">
          <div class="col-md-3 p-0">
            <h5 class="mb-0 form-name">KHỞI HÀNH</h5>
          </div>
          <div class="col">     
        ...
        <div class="form-row mb-4">
        <div class="col-md-3 ">
            <h5 class="form-name mb-0">ĐẾN</h5>
          </div>          
          <div class="col">
        ...
        <div class="form-row">
          <div class="col">
            <div class="input-group">
                <label for="dura">Lượng thời gian</label>
          ...
          echo '<select class="airline col-md-3 mt-4" name="airline_name" style="border: 0px; border-bottom: 
            2px solid #5c5c5c; background-color: whitesmoke !important;">
            <option selected>Chọn máy bay</option>';
          while ($row = mysqli_fetch_assoc($result)) {
        ...
        <button name="flight_but" type="submit" 
          ...
          <i class="fa fa-lg fa-arrow-right"></i> Thêm
          </div>
        </button>
      </form>
    </div>

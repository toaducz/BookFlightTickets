...
.dashbord-red .detail-section{
            ...
            <div class="main-section">
              ...
              <div class="dashbord dashbord-green">
                <div class="icon-section">
                 ...
                 Doanh thu
                  <p><?php include 'amtcnt.php';?> VND</p>
                </div>
      ...
      <div class="card-body">
          <div class="dropdown" style="float: right;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              ...
              <a class="dropdown-item" href="#issue">Các chuyến bay gặp sự cố hôm nay</a>
              <a class="dropdown-item" href="#dep">Các chuyến bay đã khởi hành hôm nay</a>
              <a class="dropdown-item" href="#arr">Các chuyến bay đã đến hôm nay</a>
            </div>
          </div>        
              ...
              <?php
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                  if($row['status']== '') {
                    echo '     
                <td scope="row">
                  <a href="pass_list.php?flight_id='.$row['flight_id'].'" style="text-decoration:underline;">'.$row['flight_id'].' </a> </td>
                <td>'.$row['arrivale'].'</td>
                <td>'.$row['departure'].'</td>
                    ...
                    <div class="dropdown-menu">
                      <form class="px-4 py-3"  action="../includes/admin/admin.inc.php" method="post">
                        ...
                        <div class="form-group">
                          <label for="exampleDropdownFormEmail1">Nhập thời gian (phút)                           
                          </label>
                          <input type="number" class="form-control" name="issue" 
                            placeholder="VD. 120">
                        </div>  
                        <button type="submit" name="issue_but" 
                          class="btn btn-danger btn-sm">Báo cáo sự cố</button>
    ...
    <div class="card" id="issue">
      <div class="card-body">
        ...
        <p class="text-secondary">Các chuyến bay gặp sự cố hôm nay</p>
        <table class="table-sm table table-hover">
        <thead class="thead-dark">
            <tr>
              <th scope="col">#</th>
              ...
              <?php
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                  if($row['status']=='issue') {
                    echo '              
                <td scope="row">
                  <a href="pass_list.php?flight_id='.$row['flight_id'].'">'.$row['flight_id'].' </a> </td>
                <td>'.$row['arrivale'].'</td>
                <td>'.$row['departure'].'</td>
                <td>'.$row['Destination'].'</td>
                <td>'.$row['source'].'</td>
                    ...
                    <div class="dropdown-menu">
                      <form class="px-4 py-3"  action="../includes/admin/admin.inc.php" method="post">
                        ...
                        <button type="submit" name="issue_soved_but" 
                          class="btn btn-success btn-sm">Vấn đề đã được giải quyết</button>
                      </form>
                    </div>
                  </div>  
                </th>                
    ...
    <div class="card" id="dep">
      <div class="card-body">
        ...
        <p class=" text-secondary">Các chuyến bay đã khởi hành hôm nay</p>
        <table class="table-sm table table-hover">
        <thead class="thead-dark">
            <tr>
              <th scope="col">#</th>
                    ...
                    <div class="dropdown-menu">
                      <form class="px-4 py-3"  action="../includes/admin/admin.inc.php" method="post">
                        ...
                        <button type="submit" name="arr_but" 
                          class="btn btn-success">Đã đến</button>
                      </form>
                    </div>
                  </div>  
                </th>                
    ...
    <div class="card mb-4" id="arr">
      <div class="card-body">
        ...
        <p class=" text-secondary">Các chuyến bay đã đến hôm nay</p>
        <table class="table-sm table table-hover">
        <thead class="thead-dark">
        <tr>
              <th scope="col">#</th>

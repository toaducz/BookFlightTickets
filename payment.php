...
<?php
  if(isset($_GET['error'])) {
    if($_GET['error'] === 'sqlerror') {
      ...
      echo"<script>alert('không có chuyến khứ hồi hợp lệ')</script>";
...
?>
    ...
    <div class="row">
        <div class="col-12 col-sm-8 col-md-6 col-lg-4 mx-auto">
          <h1 class="text-center text-light">Thanh toán</h1>
            <div id="pay-invoice" class="card">
                <div class="card-body">
            <label for="fname">Các thẻ khả dụng</label>
            ...
            <form action="includes/payment.inc.php" method="post" 
                ...
                <div class="form-group">
                    <label for="cc-number" class="control-label mb-1">Số thẻ</label>
                    <input id="cc-number" name="cc-number" type="tel" class="form-control cc-number identified visa" required autocomplete="off"  >
                    <span class="invalid-feedback">Vui lòng nhập số thẻ hợp lệ từ 12 - 16 số</span>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="cc-exp" class="control-label mb-1">Hết hạn</label>
                            <input id="cc-exp" name="cc-exp" type="tel" class="form-control cc-exp" required placeholder="MM / YY" autocomplete="cc-exp">
                            <span class="invalid-feedback">Nhập ngày hết hạn</span>
                        </div>
                    </div>
                    <div class="col-6 p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col pr-0">                            
                                <span class="invalid-feedback order-last">Nhập mã 3 chữ số ở mặt sau</span>
                                <div class="input-group-append"><!-- log on to freeprojectscodes.com for more projects -->
                                    ...
                                    data-content="<div class='text-center one-card'>Mã 3 chữ số ở sau thẻ<div class='visa-mc-cvc-preview'></div></div>"
                ...
                <div class='col-md-12 mb-2'>
                    ...
                    class="btn btn-lg btn-primary btn-block">
                        ...
                        <span id="payment-button-amount">Thanh toán </span>
                        <span id="payment-button-sending" style="display:none;">Đang xử lý...</span>
                    </button>
                </div>
            </form>
                </div>
    ...
    if (form[0].checkValidity() === false) {
      ...
      e.stopPropagation();
       ...
       if (!regCardNo.test(CardNo)) {
        ...
        $("#cc-number").focus();
        alert("Nhập số thẻ hợp lệ từ 10 đế 16 chữ số");
        return false;
      }

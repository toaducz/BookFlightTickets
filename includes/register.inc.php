            ...
            if($username_check > 0) {
                ...
                if(!mysqli_stmt_prepare($stmt,$email_sql)) {
                    ...
                    if($email_check > 0) {
                        ...
                        $sql = 'INSERT INTO Users (username,email,password,firstname,midname,lastname,phone,date) VALUES (?,?,?,?,?,?,?,?)';
                        $stmt = mysqli_stmt_init($conn);
                        if(!mysqli_stmt_prepare($stmt,$sql)) {
                            ...
                            mysqli_stmt_bind_param($stmt,'ssssssss',$username,$email_id,$pwd_hash,$firstname,$midname,$lastname,$phone,$date);            
                            mysqli_stmt_execute($stmt);  

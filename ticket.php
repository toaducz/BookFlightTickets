...
<main>
  <?php if(isset($_SESSION['userId'])) {   
    ...
    <h1 class="text-center text-light mt-4 mb-4">Thông tin vé</h1>
                      ...
                      if($row_f = mysqli_fetch_assoc($result_f)) {
                        ...
                        <div class="col-8 out">
                            <div class="row ">                                                     
                                ...
                                <div class="col">
                                    <h2 class="mb-0">HẠNG '.$class_txt.'</h2>
                                </div>
                            </div>
                            <hr>
                            <div class="row mb-3">  
                                <div class="col-4">
                                    <p class="head">Loại máy bay</p>
                                    <p class="txt">'.$row_f['airline'].'</p> 
                                </div>            
                                <div class="col-4">
                                    <p class="head">Khởi hành</p>
                            ...
                            <div class="row mb-3">
                                <div class="col-8">
                                    <p class="head">Khách hàng</p>
                                    <p class=" h5 text-uppercase">
                                    '.$row_p['f_name'].' '.$row_p['m_name'].' '.$row_p['l_name'].'
                                    </p>                              
                                </div>
                                <div class="col-4">
                                    <p class="head">Thời gian lên máy bay</p>
                                    <p class="txt">15:00</p>
                                </div> 
                            </div>
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <p class="head">chỗ ngồi</p>
                                    <p class="txt">'.$row['seat_no'].'</p>
                                </div>                
                            </div>                    
                        </div>
                        <div class="col-3 pl-0" style="background-color:#645b55    !important;
                            ...
                            <div class="row justify-content-center">
                                <div class="col-12">                                    
                                    <img src="assets/images/Jetstarlogo.svg"" class="mx-auto d-block"
